...
namespace SonyCameraRemoteControl
{
    ...
    public class SonyCameraDevice
    {
        ...
        public async static Task<SonyCameraDevice> GetSonyDevice(DiscoveredSsdpDevice discoveredDevice)
        {
            ...
            System.IO.File.WriteAllText(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "device_" + Guid.NewGuid() + ".log"), System.Text.UTF8Encoding.UTF8.GetString(data, 0, data.Length));
